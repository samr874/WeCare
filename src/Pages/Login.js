    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
      <div style={{ display: 'flex', flexDirection: 'row', gap: '5rem',alignItems: 'center', justifyContent: 'center',width:'100%',marginTop:'10rem'}}>
        ...
        <h4>Register yourself as practioner or healthcare individuals</h4>
          ...
          <NavLink to="/loginAsHealthcare"><button  style={{backgroundColor:'blue',width:'10rem',height:'4rem',fontWeight:'bolder',color:'white'}}>Login</button></NavLink>
          <button  style={{backgroundColor:'blue',width:'10rem',height:'4rem',fontWeight:'bolder',color:'white'}}>Register</button>
        </div>
        ...
        <h4>Register yourself as practioner or healthcare individuals</h4>
          ...
          <button  style={{backgroundColor:'blue',width:'10rem',height:'4rem',fontWeight:'bolder',color:'white'}}>Login</button>
          <button  style={{backgroundColor:'blue',width:'10rem',height:'4rem',fontWeight:'bolder',color:'white'}}>Register</button>
        </div>
      </div>
    </div>
